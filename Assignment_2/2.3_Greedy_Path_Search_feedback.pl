% FEEDBACK:
% 20/30 points, implementation doesn't seem to work and even fails your own example query
% So 20 is the absolute max I can give you for good looking code + comments
% We're not supposed to go bug hunting, but if it's a trivial one, write me an email
% and we can talk about giving you more points: tobias.voelk@fau.de
